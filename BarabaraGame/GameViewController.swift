...
class GameViewController: UIViewController {
    ...
    @IBOutlet var resultLabel: UILabel! //スコアを表示するライン
    ...
    func start() {
        ...
        @IBAction func stop() {
            ...
            if score > highScore1 { //ランキング１位の記録を更新したら
                ...
                //"score2"というキーでhighscore1(元１位の記録)を保存
                defaults.set(highScore2, forKey: "score3")
                //"score3"というキーでhighscore2(元２位の記録)を保存
            } else if score > highScore2 { //ランキング２位に記録を更新したら
                defaults.set(score, forKey: "score2") //"score2"というキーでscoreを保存
                defaults.set(highScore2, forKey: "score3")
                //"score3"というキーでhighscore2(元２位の記録)を保存
            } else if score > highScore3 { //ランキング３位に記録を更新したら
                defaults.set(score, forKey: "score3") //"score3"というキーでscoreを保存
            }
            defaults.synchronize()
        }
    
    //リトライボタンを押したらもう一回遊べるようにする
    @IBAction func retry() {
